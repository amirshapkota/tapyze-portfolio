...
const teamMembers = [
  {
    name: "Sarah Chen",
    role: "CEO & Co-Founder",
    bio: "Former fintech executive with 15+ years experience in digital payments and financial services. Led product teams at major payment processors.",
    image: "/placeholder.svg?height=400&width=400",
    linkedin: "#",
    twitter: "#",
    email: "sarah@tapyze.com",
  },
  {
    name: "Marcus Rodriguez",
    role: "CTO & Co-Founder",
    bio: "Software architect specializing in secure payment systems and NFC technology. Previously built payment infrastructure for Fortune 500 companies.",
    image: "/placeholder.svg?height=400&width=400",
    linkedin: "#",
    twitter: "#",
    email: "marcus@tapyze.com",
  },
  {
    name: "Emily Watson",
    role: "Head of Product",
    bio: "Product strategist with expertise in user experience design and mobile applications. Passionate about making complex technology simple and accessible.",
    image: "/placeholder.svg?height=400&width=400",
    linkedin: "#",
    twitter: "#",
    email: "emily@tapyze.com",
  },
  {
    name: "David Kim",
    role: "Head of Business Development",
    bio: "Business development leader with deep experience in merchant services and partnership strategy. Focused on expanding Tapyze's market reach.",
    image: "/placeholder.svg?height=400&width=400",
    linkedin: "#",
    twitter: "#",
    email: "david@tapyze.com",
  },
]
